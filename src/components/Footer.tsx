    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Departamento de Mastologia</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Cuidando da saúde das mulheres com excelência e dedicação. Nossa equipe de especialistas está pronta para oferecer o melhor tratamento em mastologia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">contato@clinicamastologia.com.br</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Departamento de Mastologia. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
